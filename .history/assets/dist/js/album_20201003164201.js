...
function createDA(DA_doc, classStr) {
    ...
    $.getJSON(DA_doc, function (json) {
        $.each(json, function (i, item){
            ...
            console.log(document.querySelector(`.btn-primary-group > .${DA_joint_tag}`))
...
DA_Nav.prototype.DACreatingComplete = function(StickyTop_object) {
    ...
    if(this._created <= 0 && StickyTop_object !==undefined) {
        ...
        console.log(document.querySelector(`.btn-primary-group > .${this.getJointTag()}`));
...
DA_Nav.prototype._scrollEventBinding = function () {
    ...
    thisDA_Nav._DA_btn.addEventListener("click", () => {
        ...
        $('html, body').animate({scrollTop: targetTop}, 800, "easeInOutQuart");
    })
}
