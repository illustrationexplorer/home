...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        if(parseInt(thisDA_Nav._sticky_top.getBoundingClientRect().bottom) <= current_displayToTop && !thisDA_Nav._sticky_top.classList.contains("active")) {
            console.log(thisDA_Nav._sticky_top.getBoundingClientRect().bottom);
            console.log(current_displayToTop);
            console.log("0")
            stickyOnAnimation(stickyTopElem);
        } else if(parseInt(Math.round(window.scrollY)) <= parseInt(thisDA_Nav._sticky_top.offsetTop) + 0.5*displayVisibleHeight && thisDA_Nav._sticky_top.classList.contains("active")) {
            console.log("1")
