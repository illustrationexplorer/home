...
DA_Nav.prototype._interactionInit = function () {
    if(this._created) {
        ...
        this._sticky_top = document.querySelector(`#${this.getJointTag()} > .deck-reminder`);
...
DA_Nav.prototype._stickyOn = function() {
...
DA_Nav.prototype._stickyOff = function() {
    if(this.hasOwnProperty("_in_sticky"))   {
        this._in_sticky = false;
        return true;
    } else {
...
DA_Nav.prototype._topEventBinding = function () {
    let tag = this.getJointTag();
    $(window).scroll(function(){
        console.log(document.querySelector(`#${tag} > .deck-reminder`))
        // if(parseInt(Math.round(window.scrollY)) === this._sticky_top.offsetTop) {
        //     console.log("Yes! ", this._DA_nav_tag);
        //     this._stickyOn();
        // } else {
        //     this._stickyOff();
        // }
