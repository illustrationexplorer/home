...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        // console.log(parseInt(Math.round(window.scrollY)) == document.querySelector("#items > .deck-reminder").offsetTop)
        // mark DA state
        console.log(parseInt(Math.round(thisDA_Nav._sticky_top.getBoundingClientRect().y)));
        if(parseInt(Math.round(thisDA_Nav._sticky_top.getBoundingClientRect().y)) === document.querySelector("#card-display").offsetTop) {
