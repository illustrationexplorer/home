    ...
    let stickySpy = function() {
        ...
        if(parseInt(sticky_top.getBoundingClientRect()["top"]) > parseInt(container.getBoundingClientRect()["top"])) {
            ...
            if(sticky_top.classList.contains("active-sticky")){
                console.log("AAAAAAAAAAAAAAAAAAAA", thisDA_Nav._DA_nav_tag)
            ...
            if(parseInt(display_deck.getBoundingClientRect()["top"]) >= parseInt(sticky_top.getBoundingClientRect()["bottom"]) - 5) {
            ...
            if(parseFloat(getComputedStyle(sticky_top, null)["opacity"]) === 1 && (parseInt(display_deck.getBoundingClientRect()["bottom"]) - parseInt(container.getBoundingClientRect()["top"]) <= deltaY)) {
