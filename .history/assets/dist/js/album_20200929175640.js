...
DA_Nav.prototype._topEventBinding = function () {
    ...
    let stickyOnAnimation = function() {
        $(thisDA_Nav._sticky_top).fadeTo("normal", 0, () => thisDA_Nav._display_desc.hide(1)).fadeTo("normal", 1);
    };
    let stickyOffAnimation = function() {
        $(thisDA_Nav._sticky_top).fadeTo("normal", 0, () => thisDA_Nav._display_desc.show(1)).fadeTo("normal", 1);
    }
