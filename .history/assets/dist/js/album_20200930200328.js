...
function loadData(DA_doc, DP_doc, card_doc) {
    ...
    let stickyTop = new StickyTop();
    stickyTop.appendToDisplay();
...
StickyTop.prototype.showDisplay = function(DA_sticky_top_elem, sticky_top_container) {
    ...
    sticky_top_container = sticky_top_container || undefined;

    if(sticky_top_container === undefined || DA_sticky_top_elem === undefined) 
        return false;
