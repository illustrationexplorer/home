...
function StickyTop(DA_Nav_object) {
    ...
    this._sticky_top = DA_Nav_object instanceof DA_Nav ? createStickyTop(this._DA_Nav_arr[0]._getStickyTop()) : document.createElement("div.deck-reminder.active-sticky");
}
