...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        if(parseInt(Math.round(window.scrollY)) > parseInt(thisDA_Nav._sticky_top.offsetTop) && !thisDA_Nav._isSticky()) {
            ...
            [ , prev_sticky_top] = thisDA_Nav._sticky_top_object.showDisplay(thisDA_Nav._sticky_top);
            thisDA_Nav._stickyToggle(true);
            thisDA_Nav._recordPrevDA_Nav(prev_sticky_top);
            ...
            prev_sticky_top = thisDA_Nav._getPrevDA_Nav();
            thisDA_Nav._stickyToggle(false);
            thisDA_Nav._sticky_top_object.showDisplay(prev_sticky_top);
        }
