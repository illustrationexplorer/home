...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        if(parseInt(Math.round(window.scrollY-1)) > parseInt(thisDA_Nav._sticky_top.offsetTop) && !thisDA_Nav._isSticky()) {
        ...
        } else if(parseInt(Math.round(window.scrollY-1)) <= parseInt(thisDA_Nav._sticky_top.offsetTop) && thisDA_Nav._isSticky()) {
