...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        if(parseInt(thisDA_Nav._sticky_top.getBoundingClientRect().bottom) <= 0 || getComputedStyle(thisDA_Nav._sticky_top).opacity === "0") {
            stickyOnAnimation(stickyTopElem);
        } else if(parseInt(Math.round(window.scrollY)) <= parseInt(thisDA_Nav._sticky_top.offsetTop) + 0.5*displayVisibleHeight || getComputedStyle(thisDA_Nav._sticky_top).opacity === "1") {
