...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        } else if(parseInt(Math.round(window.scrollY)) <= parseInt(thisDA_Nav._sticky_top.offsetTop) - 0.5*displayVisibleHeight && stickyTopElem.classList.contains("active")) {
            // console.log(parseInt(Math.round(window.scrollY)));
            console.log("1")
            console.log(parseInt(thisDA_Nav._sticky_top.offsetTop));
            console.log(thisDA_Nav._DA_nav_tag);
