...
function StickyTop(DA_Nav_object) {
    ...
    this._DA_Nav_arr = DA_Nav_object instanceof DA_Nav ? [DA_Nav_object, new DA_Nav()] : [new DA_Nav(), new DA_Nav()];
...
StickyTop.prototype.appendToDisplay = function(container, top) {
    ...
    this._sticky_top.style.cssText = ` position: fixed; width: ${width}px; z-index: 500; top: ${top}px;`;
