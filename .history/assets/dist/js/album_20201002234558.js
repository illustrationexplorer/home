...
StickyTop.prototype._eventBinding = function(container) {
    ...
    window.onscroll = function() {
        ...
        if((parseInt(current_display_desc.getBoundingClientRect()["top"]) > parseInt(displayToTop))  || (parseInt(current_display_deck.getBoundingClientRect()["bottom"]) < (0.5*displayVisibleHeight) + parseInt(displayToTop))){
            ...
            if(thisStickyTop._shown === 0){
                ...
                thisStickyTop.fadeTo(120, thisStickyTop._shown);
