...
DA_Nav.prototype._interactionInit = function () {
    if(this._created) {
        ...
        this._display_part = document.getElementById(this._DA_joint_tag);
...
DA_Nav.prototype._getDisplayPart = function() {
    if(!this.hasOwnProperty("_display_part")) {
        console.log("The display has not been deployed yet.");
        return undefined;
    }

    return this._display_part;
}
