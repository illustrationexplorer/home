...
function StickyTop(DA_Nav_object) {
    ...
    let _sticky_top = DA_Nav_object instanceof DA_Nav ? createStickyTop(this._DA_Nav_arr[0]._getStickyTop()) : document.createElement("div");
    this._sticky_top = _sticky_top.classList.add("deck-reminder", "active-sticky");
}
