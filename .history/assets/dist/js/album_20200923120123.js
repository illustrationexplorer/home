...
function createDA(DA_doc, classStr) {
    ...
    $.getJSON(DA_doc, function (json) {
        $.each(json, function (i, item){
            ...
            let sub_label = $("<ul></ul>").addClass("display-sub-label sticky-top");
            ...
            let display_title = $("<h2></h2>").addClass("display-title sticky-top").text(DA_display_tag + " (" + DA_num + ")");
            display_title.prepend($("<span></span>").css("background-color", DA_nav_color));
           
            currentDisplayPart
            .append(display_title)  // create display title
            .append($("<p></p>").addClass("display-desc sticky-top").text(DA_desc)) // create display description
