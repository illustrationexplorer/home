...
DA_Nav.prototype._interactionInit = function () {
    if(this._created) {
        ...
        this._prev_sticky_top = undefined;
...
DA_Nav.prototype._recordPrevStickyTop = function(sticky_top) {
    ...
    sticky_top = sticky_top || undefined;

    this._prev_sticky_top = sticky_top;
    return true;
}

DA_Nav.prototype._getPrevStickyTop = function() {
    if(!this.hasOwnProperty("_prev_sticky_top")) {
        console.log("Either sticky top or DA button has been deployed yet.");
        return undefined;
    }

    return this._prev_sticky_top;
}

DA_Nav.prototype._getCurrentStickyTop = function() {
...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        if(parseInt(Math.round(window.scrollY)) > parseInt(thisDA_Nav._sticky_top.offsetTop) && !thisDA_Nav._isSticky()) {
            ...
            thisDA_Nav._recordPrevStickyTop(prev_sticky_top);
            ...
            prev_sticky_top = thisDA_Nav._getPrevStickyTop();
...
function StickyTop(DA_sticky_top) {
    ...
    // this._sticky_top = createStickyTop(this._DA_Nav_arr[0]._getCurrentStickyTop());
...
StickyTop.prototype.showDisplay = function(DA_sticky_top_elem, sticky_top_container) {
    ...
    // let DA_sticky_top_elem = DA_Nav_object._getCurrentStickyTop();
