...
// function StickyTop(DA_sticky_top) {
    ...
    // this._DA_sticky_top_arr = [DA_sticky_top, undefined] || [undefined, undefined];
    ...
    this._sticky_top = DA_Nav_object instanceof DA_Nav ? createStickyTop(this._DA_Nav_arr[0]._getStickyTop()) : undefined;
    // this._sticky_top = createStickyTop(this._DA_sticky_top_arr[0]);
}
