...
StickyTop.prototype._eventBinding = function(container) {
    ...
    window.onscroll = function() {
        ...
        // console.log("A:", parseInt(current_display_deck.getBoundingClientRect()["top"]) > parseInt(displayToTop));
        // console.log("B:", (parseInt(current_display_deck.getBoundingClientRect()["bottom"]) < (0.33*displayVisibleHeight) + parseInt(displayToTop))
        if((parseInt(current_display_deck.getBoundingClientRect()["top"]) < parseInt(displayToTop))  || (parseInt(current_display_deck.getBoundingClientRect()["bottom"]) > (0.33*displayVisibleHeight) + parseInt(displayToTop))){
