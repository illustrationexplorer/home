...
DP_Tab.prototype._interactionInit = function() {
    this._DP_primary_btn = document.querySelectorAll(".btn-secondary-group > .btn")[this._DP_id];
    this._DP_sub_ul = document.querySelectorAll(".btn-secondary-group > .btn-sub-list")[this._DP_id];
}
