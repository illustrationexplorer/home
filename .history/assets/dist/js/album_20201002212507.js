...
DA_Nav.prototype._topEventBinding = function () {
    ...
    $(window).scroll(function(){
        ...
        if(parseInt(Math.round(window.scrollY)) > parseInt(thisDA_Nav._sticky_top.offsetTop) && !thisDA_Nav._inDisplay()) {
            ...
            if(prev_DA_Nav !== undefined) prev_DA_Nav._displayToggle(false);
        ...
        if(thisDA_Nav._inDisplay())
            console.warn("shown", thisDA_Nav._DA_nav_tag);
        else
            console.log("hidden", thisDA_Nav._DA_nav_tag);
    });
}
